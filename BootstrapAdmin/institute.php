               ...
               <div class="row">
                <div class="span12">
                    <form id="custom-search-form" class="form-search form-horizontal pull-right">
                        ...
                        <input type="text" class="search-query" placeholder="Search Offers" style="width: 650px;">
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-sm-6 text-right">
                  <p>Design by <a href="https://bootstrapious.com/admin-templates" class="external">YASH</a></p>
