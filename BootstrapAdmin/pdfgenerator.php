...
$html = 'These are the details of the Booking for the Industrial Visit Booked by <br><br><b>'.$name.'</b>, on <a href="http://localhost/code/eyevee">eyeVee</a>.';
$pdf->WriteHTML($html);
$pdf->Ln(20);
...
$pdf->Table($link,'select bookingid as "Booking ID",studentname as "Student Name",studentid as "Student ID" from studentdetails  where bookingid ="'.$_SESSION['bookingidtiredbro'].'" order by studentid ');
$pdf->Ln(5);
...
$pdf->Output('PDF/INDUSTRIAL VISIT BOOKING DETAILS.pdf','F');

echo "<script>window.location = 'pdfemail.php';</script>";
?>
