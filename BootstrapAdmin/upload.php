...
<html>
  <head>
    ...
    <title>eyeVee - Upload Offer</title>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="upload.php"> <i class="icon-padnote"></i>Upload Offer </a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Upload Offer</h2>
            </div>
          </header>
          <!-- Breadcrumb
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form method="post" class="form-horizontal" action="industry.php">
